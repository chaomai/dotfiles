...
if system('uname -r') =~ 'microsoft'
    ...
    " powershell is slow
    " noremap p :r !powershell.exe -Command Get-Clipboard<cr>
endif


" project files
let g:project_source_file = []

" root for all plugins
let g:project_root =
            \ [
            \     ".ccls-root", ".idea", "go.mod", ".bzr", "_darcs",
...
if has("nvim")
    if has("macunix")
        let g:python3_host_prog = "/usr/local/Caskroom/miniconda/base/envs/common_env_python3.9/bin/python"
    else
        let g:python3_host_prog = expand("~/.local/opt/miniconda3/envs/common_env_python3.9/bin/python")
    endif

    let g:node_host_prog = expand("$DEFAULT_NODE_PATH/neovim-node-host")
endif
...
augroup InitFileTypesGroup
    ...
    au FileType sh setlocal tw=150
